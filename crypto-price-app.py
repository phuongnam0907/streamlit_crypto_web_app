...
def load_data():
    ...
    listings = coin_data['props']['initialState']['cryptocurrency']['listingLatest']['data'][0]['keysArr']
    index_slug = listings.index("slug")
    index_symbol = listings.index("symbol")
    index_price = listings.index("quote." + str(currency_price_unit) + ".price")
    index_percentChange1h = listings.index("quote." + str(currency_price_unit) + ".percentChange1h")
    index_percentChange24h = listings.index("quote." + str(currency_price_unit) + ".percentChange24h")
    index_percentChange7d = listings.index("quote." + str(currency_price_unit) + ".percentChange7d")
    index_marketCap = listings.index("quote." + str(currency_price_unit) + ".marketCap")
    index_volume24h = listings.index("quote." + str(currency_price_unit) + ".volume24h")
    ...
    for i in listings:
      coin_name.append(i[index_slug])
      coin_symbol.append(i[index_symbol])
      price.append(i[index_price])
      percent_change_1h.append(i[index_percentChange1h]) # percent_change_1h
      percent_change_24h.append(i[index_percentChange24h]) #percent_change_24h
      percent_change_7d.append(i[index_percentChange7d]) # percent_change_7d
      market_cap.append(i[index_marketCap]) # market_cap
      volume_24h.append(i[index_volume24h]) # volume_24h
